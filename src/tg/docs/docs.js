...
import stanzaPadImg from '../../../public/tg/docs-images/stanza-pad-home-coloured.png'
...
const Docs = (props) => {
    ...
    return (
        ...
        <div className={classes.container}>
            ...
            <h2 id="generate">GENERATE SECTION</h2>
            ...
            <ul>
                <li><b>preset</b>: select the input text from which stanzas are generated. Select a preset from the dropdown menu (new presets can be added via the SOURCE PAD).</li>
            ...
            <h2 id="stanza-pad">STANZA PAD</h2>
            ...
            <ul>
                ...
                <li><b>undo/redo</b>: revert the stanza pad to its previous state (note: buggy af)</li>
            </ul>
            <h2 id="word-bank">WORD BANK</h2>
            <p>This section allows you to collect and store words for manually adding to the STANZA PAD. The main WORD BANK area behaves much as the STANZA PAD, where words can be selected and unselected by clicking on them. POPULATE adds new words to the WORD BANK. INJECT transforms your current stanza.</p>
            <h3>WORD BANK BUTTONS</h3>
            <ul>
            ...
            <h2 id="output">OUTPUT SECTION</h2>
            ...
            <h2 id="source-pad">SOURCE PAD</h2>
            ...
            <h2 id="global">GLOBAL SECTION</h2>
