...
const ShowAsGrid = (props) => {
    ...
    const onChangeGridX = (e) => {
        setGridX(e.target.value);
    }

    const onChangeGridY = (e) => {
    ...
    return (
        <div className={classes.pageContainer}>
          ...
          <div className={classes.panel}>
            ...
            <input type="range" id="grid-x" name="grid-x" min="1" max="10" step="1" onChange={onChangeGridX} value={gridX}/>
            <input type="range" id="grid-y" name="grid-y" min="1" max="10" step="1" onChange={onChangeGridY} value={gridY}/>
